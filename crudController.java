...
public class crudController implements Initializable {
    ...
    // Method to populate the table from the database
    public void populateTable() {
        try (Connection connection = DriverManager.getConnection(jdbcUrl, dbUser, dbPassword)) {
            ...
            while (resultSet.next()) {
                ...
                list.add(new dental_appoint(id, paintentName, phone, payment)); // Add the items to the list
            }
    ...
    // View Data (triggered by the "View Data" button)
    @FXML
    ...
    // Optional: Load Data if you want a specific button to reload data
